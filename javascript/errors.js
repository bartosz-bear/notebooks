...
//The "TypeError: (intermediate value)(...) is not a function" error occurs
// when we forget to place a semicolon between a function declaration and an
// immediately invoked function expression. To solve the error,
