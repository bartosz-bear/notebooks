...
- map() method reads the length property of 'this' and then accesses each integer index
...
- `accumulator` - first argument, it accumulates the results of all previous operations, on each previous item
